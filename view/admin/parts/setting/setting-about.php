<div id="about" class="woo-invoice-stylist-tab" style="display:none">
    <section>
        <h2>About</h2>
        <p>
            ...
            . I will also continue to add
            <b>new templates</b>
            to keep up with the latest design trends and provide even more options for customization.

            I hope you enjoy using Invoice Styler as much as I do, and I look forward to continuing to improve the plugin and add new features
            <b>based on your feedback</b>.
        </p>
        ...
        <h2>Bug Fixes Log</h2>
        <ol>
            <li>There have been no reported bugs</li>
        </ol>
    </section>
    <hr>
    <footer>
        <p>Plugin developed by <b>Farid Haghgooyan</b></p>
